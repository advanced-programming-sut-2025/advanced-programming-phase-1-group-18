...
//        player =getCurrentPlayer();
    ...
    private void loadActionTable() {
        Message res = ActionMessageHandler.getLinkedList(App.getCurrentUser().getID());
        Gson gson = new Gson();
        Object linkedList = res.getFromBody("linkedList");
        String linkStr = gson.toJson(linkedList);
        Type listType = new TypeToken<LinkedList<ActionEnum>>(){}.getType();
        actions = gson.fromJson(linkStr, listType);
